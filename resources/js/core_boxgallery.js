var ssdLight = {
    ...
    containerLightBox: '<div id="lightbox"><div id="lightbox-wrapper"><div id="lightbox-content"></div><div id=""><span id="lightbox-close">Close</span><div class="prevContainer"><span id="lightbox-prev" class="paging"></span></div><span id="lightbox-prev-inactive" class="paging"></span><span id="lightbox-next" class="paging"></span><span id="lightbox-next-inactive" class="paging"></span></div></div></div>',
    run: function (obj) {
        ...
        imgObject.onload = function () {
            ...
            var posTop = (windowHeight / 2) -
                ((ssdLight.imgHeight + (ssdLight.imgPaddingVer + ssdLight.toolsHeight)) / 2);
    ...
    hoverTitle: function () {
        if (ssdLight.titleDisplay) {
            $('#lightbox-content').hover(function () {
                ...
                var selector = $('#lightbox-title'),
                    w = selector.width();
                selector.css('left', (ssdLight.imgWidth / 2) - ((w / 2) + ssdLight.imgPaddingHor) + 'px').show();
            }, function () {
    ...
    checkMaxSize: function () {
        var windWidth = $(window).width() - 20,
            ...
            factorMaxSize = 0.9,
            percentResize;
        if (windWidth < ssdLight.imgWidth) {
            percentResize = windWidth * factorMaxSize / ssdLight.imgWidth;
            ssdLight.imgWidth = windWidth * factorMaxSize;
            ssdLight.imgHeight *= percentResize;
        } else if (winHeight < ssdLight.imgHeight) {
            percentResize = winHeight * factorMaxSize / ssdLight.imgHeight;
            ssdLight.imgHeight = winHeight * factorMaxSize;
            ssdLight.imgWidth *= percentResize;
        }
    }
};
$(function () {
